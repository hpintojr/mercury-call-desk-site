  ...
  return (
    <DemoCtx.Provider value={{ open, close, isOpen }}>
      ...
      <aside role="dialog" aria-modal="true" aria-label={`See ${site.name} in action`} aria-hidden={!isOpen}
        ...
        <header className="relative flex flex-col items-start gap-1 border-b border-mcd-line px-5 pb-5 pt-5 text-left">
        ...
        <div className="relative min-h-[520px] flex-1 bg-mcd-surface">
          {mounted && (
